                    ...
                    <div class=" ">
                        ...
                        <?php 
                            // if ($this->Employee->has_module_action_permission($controller_name, 'add_update', $this->Employee->get_logged_in_employee_info()->person_id)) {
                                echo anchor(
                                    "$controller_name/faculty/-1/",
                                    '<i title="' . 'New' . '" class="fa fa-pencil tip-bottom hidden-lg fa fa-2x"></i><span class="visible-lg">' . 'Faculty' . '</span>',
                                    array(
                                        'id' => 'new-person-btn',
                        ...
                        <?php 
                            // if ($this->Employee->has_module_action_permission($controller_name, 'add_update', $this->Employee->get_logged_in_employee_info()->person_id)) {
                                echo anchor(
                                    "$controller_name/skill/-1/",
                                    '<i title="' . 'Skill' . '" class="fa fa-pencil tip-bottom hidden-lg fa fa-2x"></i><span class="visible-lg">' . 'Skill' . '</span>',
                                    array(
                                        'id' => 'new-person-btn',
                                        'class' => 'btn btn-primary',
                                        'title' => 'Skill'
                        ...
                        <table class="tablesorter table table-bordered  table-hover" id="sortable_table">
                            ...
                            <tbody>
                                <tr style="cursor: pointer;"><td><input type="checkbox" id="person_1" value="1"></td>
                                    <td>1</td>
                                    <td>គ្រប់គ្រងពាណិជ្ជកម្ម និង ទេសចរណ៍</td>
                                ...
                                <tr style="cursor: pointer;"><td><input type="checkbox" id="person_1" value="1"></td>
                                    <td>2</td>
                                    <td>សិល្បៈ មនុស្សសាស្រ្ត និង ភាសាបរទេស</td>
                                    <td class="action-buttons">
                                        <a href="#" title="view" class="gray">
                                                <i class="ace-icon fa fa-list bigger-150"></i>
                                        </a>
                                ...
                                <tr style="cursor: pointer;"><td><input type="checkbox" id="person_1" value="1"></td>
                                    <td>3</td>
                                    <td>វិទ្យាសាស្រ្ត និង បច្ចេកវិទ្យា</td>
                                    <td class="action-buttons">
                                        <a href="#" title="view" class="gray">
                                                <i class="ace-icon fa fa-list bigger-150"></i>
                                        </a>
                                ...
                                <tr style="cursor: pointer;"><td><input type="checkbox" id="person_1" value="1"></td>
                                    <td>4</td>
                                    <td>នីតិសាស្រ្ត និង សេដ្ឋកិច្ច</td>
                                    <td class="action-buttons">
                                        <a href="#" title="view" class="gray">
                                                <i class="ace-icon fa fa-list bigger-150"></i>
                                        </a>
                                ...
                                <tr style="cursor: pointer;"><td><input type="checkbox" id="person_1" value="1"></td>
                                    <td>5</td>
                                    <td>កសិកម្ម និង អភិវឌ្ឍន៍ជនបទ</td>
                                    <td class="action-buttons">
                                        <a href="#" title="view" class="gray">
                                                <i class="ace-icon fa fa-list bigger-150"></i>
                                        </a>
