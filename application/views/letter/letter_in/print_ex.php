...
<?php 
    ...
    header("Content-Disposition: attachment; filename=Letter IN.xls");
?>
<?php 
$headPrint="<table>
                <tr>
...
$manage_table = "<table>
                    <tr>
                        ...
                        <td style='text-align:left'>".$detail->received_date."</td> 
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style='text-align:left'>".$detail->send_from."</td> 
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style='text-align:left'>".$detail->orginazation."</td> 
                    </tr>
