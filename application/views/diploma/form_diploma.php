                    ...
                    <!-- </div>      -->
                        ...
                        Fields in red are required    <div class="widget-box">
                                ...
                                <form action="" method="post" accept-charset="utf-8" id="" class="form-horizontal" novalidate="novalidate">
                                                ...
                                                <div class="form-group" style="margin-bottom: 10px;">
                                                    <label for="generation" class="required col-sm-3 col-md-3 col-lg-2 " aria-required="true">Generation:</label>    
                                                    <div class="col-sm-9 col-md-9 col-lg-5">
                                                        <input class="filter form-control" name="generation" type="text" value="" />
                                                    </div>
                                                </div>

                                                <div class="form-group" style="margin-bottom: 10px;">
                                                    <label for="college_id" class="col-sm-3 col-md-3 col-lg-2 " aria-required="true">Department ID
                                                    (college):</label>    
                                                    <div class="col-sm-9 col-md-9 col-lg-5">
                                                        <select class="filter form-control" name="college_id">
                                                ...
                                                <div class="form-group" style="margin-bottom: 10px;">
                                                    <label for="exam1" class="required col-sm-3 col-md-3 col-lg-2 " aria-required="true">Exam-1:</label>    
                                                    <div class="col-sm-9 col-md-9 col-lg-5">
                                                        <input class="filter form-control" name="exam1" type="text" value="" />
                                                    </div>
                                                </div>

                                                <div class="form-group" style="margin-bottom: 10px;">
                                                    <label for="exam2" class="required col-sm-3 col-md-3 col-lg-2 " aria-required="true">Exam-2:</label>    
                                                    <div class="col-sm-9 col-md-9 col-lg-5">
                                                        <input class="filter form-control" name="exam2" type="text" value="" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group" style="margin-bottom: 10px;">
                                                    <label for="diploma" class="required col-sm-3 col-md-3 col-lg-2 " aria-required="true">diploma Name:</label>    
                                                    <div class="col-sm-9 col-md-9 col-lg-5">
                                                        <input class="filter form-control" name="diploma" type="text" value="" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-actions">
                                                    <div>
                                                        <a class="btn btn-active pull-right" style="margin-left:1%" href="<?=site_url("$controller_name/diploma")?>">Cancel</a>
                                                    </div>
                                                    <div>
