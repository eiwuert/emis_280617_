        ...
        <div class="row">
            <div class="col-xs-30"> 
                <div class="widget-box" id="widgets">
                    ...
                    <!-- Start -->
                        <div class="col-xs-12">                                           
                                <?php echo form_open('student_list_view/search_student'); ?>
                                        <div class="box box-solid box-info col-xs-12 col-lg-12 no-padding">
                                            ...
                                            <div class="form-group col-xs-12 col-lg-12 col-lg-12">  
                                                ...
                                                <div class="col-sm-4 col-xs-12">
                                                    ...
                                                    <input style="width: 100%;" type="text" id="search_major_code" name="major_code" value="<?php echo (($post['major_code'])? $post['major_code'] : '')?>" placeholder='Code Major' required/>
                                                </div>

                                                <div class="col-sm-4 col-xs-12">
                                                    <?php echo form_label( lang('major_name'). ':', 'fees_collect_major_id', array('class' => 'col-sm-6 col-xs-12 required no-padding')); ?>
                                                    <?php echo form_dropdown('major_name', $major, (($post['major_name'])? $post['major_name'] : ''), 'onchange="report(this.value)" id="search_major_id" class="form-control" required');?>
                                                </div>

                                                <div class="col-sm-4 col-xs-12">
                                                    <?php echo form_label( lang('year'). ':', 'fees_collect_year', array('class' => 'col-sm-6 col-xs-12 required no-padding')); ?>
                                                    <?php echo form_dropdown('year', $year, (($post['year'])? $post['year'] : ''), 'class="form-control"'); ?>                                                                
                                                </div>

                                                <div class="col-sm-4 col-xs-12">
                                                    <?php echo form_label( lang('batch'). ':', 'fees_collect_batch', array('class' => 'col-sm-6 col-xs-12 required no-padding')); ?>
                                                    <?php echo form_dropdown('batch', $batches, (($post['batch'])? $post['batch'] : ''), 'class="form-control"'); ?>
                                                </div>

                                                <div class="col-sm-4 col-xs-12">
                                                    <?php echo form_label( lang('period'). ':', 'fees_collect_period', array('class' => 'col-sm-6 col-xs-12 required no-padding')); ?>
                                                    <?php echo form_dropdown('period', $period, (($post['period'])? $post['period'] : ''), 'class="form-control"'); ?>                                                                                                                        
                                                </div> 

                                                <div class="col-sm-4 col-xs-12">
                                                    <?php echo form_label( lang('degree'). ':', 'fees_collect_degree', array('class' => 'col-sm-6 col-xs-12 required no-padding')); ?>
                                                    <?php echo form_dropdown('degree', $degree, (($post['degree'])? $post['degree'] : ''), 'class="form-control"'); ?>
                                                </div>

                                                <div class="col-sm-4 col-xs-12">
                                                    <?php echo form_label(lang('semester'). ':', 'fees_collect_semester', array('class' => 'col-sm-6 col-xs-12 required no-padding')); ?>
                                                    <?php echo form_dropdown('semester', $semester, (($post['semester'])? $post['semester'] : ''), 'class="form-control"'); ?>
                                                </div> 
                                                        
                                                <div class="col-sm-4 col-xs-12">
                                                    <?php echo form_label( lang('schedule'). ':', 'fee_collect_schedule', array('class' => 'col-sm-6 col-xs-12 required no-padding')); ?>
                                                    <?php echo form_dropdown('schedule', $schedule, (($post['schedule'])? $post['schedule'] : ''), 'class="form-control"'); ?>
                                                </div>                                           
                                                        
                                                <div class="col-sm-4 col-xs-12">
                                                    <?php echo form_label(lang('room'). ':', 'fees_collect_room', array('class' => 'col-sm-6 col-xs-12 required no-padding')); ?>
                                                    <?php echo form_dropdown('room', $room, (($post['room'])? $post['room'] : ''), 'class="form-control"'); ?>
                                                </div>

                                                <div class="col-sm-4 col-xs-12">
                                                    <?php echo form_label('Selection Print:', 'fees_collect_room', array('class' => 'col-sm-6 col-xs-12 required no-padding')); ?>
                                                    <?php echo form_dropdown('selection_print', $selection_print, (($post['selection_print'])? $post['selection_print'] : ''),'class="form-control" required'); ?>
                                                </div>
                                                <div class="col-sm-12 col-xs-12">
                                                    <a href="<?php echo site_url("student_list_view/clear_state")?>" style="margin-left:15px" class="btn btn-active pull-left">Clear</a> 
