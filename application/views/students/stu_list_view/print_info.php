            ...
            <div class="user_receipt">
                <table class="tblist" border="1" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <th style="width:20px">Name KH</th>
                        <th style="width:20px">Gender</th>
                        <th style="width:20px">D.O.B</th>
                        <th style="width:20px">E-mail</th>
                        <th style="width:20px">Phone</th>
                        <th style="width:20px">Admission Date</th>
                        <th style="width:20px">Nationality</th>                    
                    </tr>
                    <?php if($get_stu_info->num_rows() > 0):?>
                        ...
                        <?php foreach($get_stu_info->result() as $row): ?>
                            ...
                            <tr>
                                <td><?php echo $i?></td>
                                <td style="width:20px"><?php echo $row->stu_last_name ?> <?php echo $row->stu_first_name ?></td>
                                <td style="width:20px"><?php echo $row->stu_last_name_kh ?> <?php echo $row->stu_first_name_kh ?></td>
                                <td style="width:20px"><?php echo $row->stu_gender ?></td>
                                <td style="width:20px"><?php echo date_format(date_create($row->stu_dob),"j F, Y")?></td>
                                <td style="width:20px"><?php echo $row->stu_email_id ?></td>
                                <td style="width:20px"><?php echo $row->stu_mobile_no ?></td>
                                <td style="width:20px"><?php echo date_format(date_create($row->stu_admission_date),"j F, Y") ?></td>
                                <td style="width:20px"><?php echo $row->nationality_name ?></td>                    
                            </tr>
                        <?php endforeach ?>
                    <?php endif ?>
                </table>
