...
<script type='text/javascript'>
        ...
        $('#stu_master_skill_id').change(function(){
            ...
            $.ajax({
                ...
                success: function(get_data_row){
                    $('#stu_master_course_id').html('<option value=""> Select Courses </option>');
    ...
    $(document).ready(function()
    {
        ...
        $('#student_form').validate({            
            ...
            {      
                var wid = $('#stu_unique_id').val();
                $.post('<?php echo site_url("students/stu_unique_id_exists"); ?>', {term: wid }, function(data) {
                    if (data.duplicate == wid){
                        $('#stu_unique_id').val('');
                        $('#chExistsUniqueId').text('This ID have already exists.');
                    }else{
                        if(wid !== ''){
            ...
            rules:
            {
                ...
                stu_acad_university_id: "required",
                stu_acad_skill_id: "required",
                stu_acad_course_id: "required",
                stu_acad_batch_id: "required",
                stu_acad_section_id: "required",
                stu_acad_level_id: "required",
                stu_admission_date: "required",
                stu_acad_stu_room: "required",
                stu_acad_stu_class: "required",
                stu_acad_stu_status_id: "required",
                students_grade: "required",
                stu_acad_stu_schedule: "required",
            },
            ...
            {
                stu_unique_id: "required",
                stu_unique_id_written:"Required Field or Duplicate",
                stu_last_name: "Required Field",
                stu_first_name: "Required Field",
                stu_last_name_kh: "Required Field",
                stu_first_name_kh: "Required Field",
                stu_email_id: { required: "" },
                stu_unique_id: "requried field",
                stu_unique_id_written: { stu_unique_id_written: true },
                stu_dob: "Required Field",
                stu_acad_university_id: "Required Field",
                stu_acad_skill_id: "Required Field",
                stu_acad_course_id: "Required Field",
                stu_acad_batch_id: "Required Field",
                stu_acad_section_id: "Required Field",
                stu_acad_level_id: "Required Field",
                stu_admission_date: "Required Field",
                stu_acad_stu_room: "Required Field",
                stu_acad_stu_class: "Required Field",
                stu_acad_stu_status_id: "Required Field",
                students_grade: "Required Field",
                stu_acad_stu_schedule: "Required Field",
            }
        });
