...
<div id="mydiv">
	<style type="text/css">
			...
			.associate{
				background-image: url('<?php echo $base_css_parth?>assets/img/associate.png');
			}
			.bachelor{
				background-image: url('<?php echo $base_css_parth?>assets/img/bachelor.png');
			}
			.master{
				background-image: url('<?php echo $base_css_parth?>assets/img/master.png');
			}
			@media print {
			  body, page {
			    margin: 0;
				...
				<?php for ($i=0; $i < $count ; $i++): ?>
					<?php $limit = ($i == 0)? 0 : $p+=1;?>
								...
								<?php foreach(array_slice($get_query->result(), $limit, 1) as $key=>$row ): ?>
									<?php
										...
										$stu_gender = ($row->stu_gender == 'Male')? 'Male':'Female';
										$stu_gender_kh = ($row->stu_gender == 'Male')? 'ប្រុស':'ស្រី';
                    ...
                    $softConv = array (0=>'០',1=>'១',2=>'២',3=>'៣',4=>'៤',5=>'៥',6=>'៦',7=>'៧',8=>'៨',9=>'៩');
									...
									?>
											...
											<page size="A4" layout="portrait" class="<?php echo $level_type?>">
													<div id="body_page">
														<div id="inner_body">
											...
											នៃសាកលវិទ្យាល័យគ្រប់គ្រង និង សេដ្ឋកិច្ច</div>
																	<div class="cen_left_confirm"><div style="float:left">បញ្ជាក់ថាៈ</div><div class="conf_name"><?php echo $name_kh?></div><div style="float:left">ភេទ</div><div class="conf_gender"><?php echo $stu_gender_kh ?></div></div>
											...
											Academic Board of the University of Management and Economics</div>
																...
																<!--  -->
																<div class="foot_left">
																	<div class="f_left_date">បន្ទាយមានជ័យ ថ្ងៃទី<?php echo ($pd)? '&nbsp;'.$pd.'&nbsp;' : '..........' ?>ខែ<?php echo ($pm)? '&nbsp;'.$pm.'&nbsp;' : '..........' ?>ឆ្នាំ<?php echo ($py)? '&nbsp;'.$py.'&nbsp;' : '..........' ?></div>
																	<div class="f_left_date_bottom">ប្រធានក្រុមប្រឹក្សាភិបាល</div>
																</div>
																<div class="foot_center">
																	<div class="foot_no"><div style="float:left">លេខ</div><div style="float:left;line-height: 1;border-bottom: dotted 1px;padding: 0px 12px 0px 12px;margin:0px 2px;width: 110px; text-align:center"><?php echo ($id_diploma)? sprintf("%07s", $id_diploma++) : '&nbsp;'?></div><div style="float: left">ស.គ.ស/បជ</div></div>
																...
																<div class="foot_right">
																	<div class="foot_city_date">Banteay Meanchey, Date.<?php echo ($date_out_chairman_of_the_board)? '&nbsp;&nbsp;&nbsp;'.$date_out_chairman_of_the_board : '..................................................'?></div>
