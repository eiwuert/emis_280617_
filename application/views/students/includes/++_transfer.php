...
<script type="text/javascript">
	$(document).ready(function()
    {
        ...
        $('body').on('click', 'a.update_row_transfer', function(e){  
			...
			data_id = $(this).data('transfer-id'),
			data_transfer_type = $(this).data('transfer-type'),
			...
			$('form#transfer_form').attr('action', url);
	...
	var submitting = false;
    function doTransferSubmit(form)
    {
