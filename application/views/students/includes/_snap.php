...
<div class="tab-pane" id="snap">
	        ...
	        <tr>
	            <td valign="top">
	            	<center>
	    				...
	    				<?php echo form_hidden('stu_id',$person_info->stu_unique_id)?>
	    				<?php echo form_hidden('id_stu',$person_info->stu_info_id)?>
	                </center>
	            </td>
	...
	<script>
        webcam.set_api_url( '<?php echo base_url('assets/cam')?>/upload.php' );
        ...
        function clear_snapshot() {
        	var id_stu = $('input[name="id_stu"]').val();
        	var site_url = "<?php echo site_url('students/clear_prof')?>";
            $.post(site_url, {id_stu:id_stu},function(data, status){
				if(data == 'TRUE'){
        ...
        function my_completion_handler(msg) {
            ...
            if (msg.match(/(http\:\/\/\S+)/)) {
                ...
                var id_stu = $('input[name="id_stu"]').val();
                var site_url = "<?php echo site_url('students/snap')?>";
                var data_url = {stu_id: stu_id, id_stu:id_stu, image_name:image_name};
                if(image_url !== ''){
