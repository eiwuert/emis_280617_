                        ...
                        <div class="col-xs-12">
                            <div class="widget-box">
                                ...
                                <section class="content" style="min-height: 543px; overflow:auto">
                                    ...
                                    <?php echo $this->load->view('faculty/course/table_view2')?>
                                    
                                    <?php echo $this->load->view('faculty/course/part_time')?>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success)
                {
                    ...
                    window.location.href = '<?php echo site_url("$controller_name/view_schedule2"); ?>/'+response.course_id;
                }
                else
                {
