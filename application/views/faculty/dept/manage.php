...
<script type="text/javascript">
    ...
    {
        var table_columns = ["","dept_id","dept_title",'dept_title_kh'];
                        ...
                        <?php
                            if ($this->Employee->has_module_action_permission($controller_name, 'add_update', $this->Employee->get_logged_in_employee_info()->person_id)) {
                                echo anchor(
                                    ...
                                    '<i class="fa fa-pencil tip-bottom hidden-lg fa fa-2x"></i><span class="visible-lg">' . lang('common_new') . '</span>',
                                    array(
                                        'id' => 'new-person-btn',
            ...
            <div class="col-xs-30">
                <div class="widget-box" id="widgets">
                    <div class="widget-title">
                        ...
                        <span class="label label-info tip-left"><?php echo lang('common_clear_search'); ?></span></a>
                    </div>
                    <!-- Start -->
