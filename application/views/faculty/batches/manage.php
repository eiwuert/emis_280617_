...
<script type="text/javascript">
    ...
    {
        var table_columns = ['', 'batch_name', 'start_date', 'end_date'];
        ...
        enable_delete(<?php echo json_encode(lang('batch_confirm_delete')); ?>,<?php echo json_encode(lang("batch_none_selected")); ?>);
    });
</script>
            ...
            <div class="col-xs-30">
                <div class="widget-box" id="widgets">
                    <div class="widget-title">
                        ...
                        <a href="<?php echo site_url($controller_name.'/clear_state'); ?>" class="label label-info pull-right"><?php echo lang('common_clear_search'); ?></a>
                    </div>
