...
<script type="text/javascript">
    ...
    {
        var table_columns = ['', 'subject_name', 'subject_name_kh', 'sub_id'];
...
<div class="main-content-inner">
    ...
    <div style="margin: 0px 10px;border-bottom: solid 1px #ccc;">
        <div style="color: #fff; background: #00c0ef;background-color: #00c0ef;">
            <h3 style="display: inline-block;padding: 10px 10px 10px 10px;margin: 0;font-size: 20px;font-weight: 400;float: left;cursor: default;"><i class="fa fa-search"></i> Search Subject by Major </h3>
            <div class="clearboth"></div>
        </div>
        <?php echo form_open('subjects/print_subject'); ?>
        <div class="row" style="margin-top:10px">
            <div class="form-group required has-success text-center" style="margin-bottom: 10px;line-height: 34px;" aria-required="true">
                <label for="emp_unique_id" class=" col-sm-3 col-md-3 col-lg-2 control-label">Mjor Name:</label>
                <div class="col-sm-7 col-md-7 col-lg-7">
                    <?php echo form_dropdown('major',$major,'', 'class="filter form-control"')?>
                </div>
                <div class="col-sm-3 col-md-3 col-lg-3">
                    <input type="submit" name="submit" value="Print" class="btn btn-active form-control col-sm-3 col-md-3 col-lg-3 pull-right">      
                </div>
            </div>
        </div>
        </form>
    ...
    <div class="page-content">
        ...
        <div class="row ">
            ...
            <input type="text" name ='search' id='search' value="<?php echo H($search); ?>" placeholder="<?php echo lang('common_search'); ?>"/>
            <?php echo form_close(); ?>
        </div>
        <div class="row">
            <div class="col-xs-30">
                <div class="widget-box" id="widgets">
                    <div class="widget-title">
                        ...
                        <a href="<?php echo site_url($controller_name.'/clear_state'); ?>" class="clear-state pull-right">
                            <span title="Clear" class="label label-info tip-left"><?php echo lang('common_clear_search'); ?></span>
                        </a>
                    </div>
