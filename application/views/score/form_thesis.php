                    ...
                    <!-- Start -->
                        <div class="col-xs-12">
                            ...
                            <div class="box box-solid box-info col-xs-12 col-lg-12 no-padding">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><i class="fa fa-search"></i> <?php echo 'Add Thesis'?></h3>
                                    <div class="clearboth"></div>
                                </div><br>
                                ...
                                <div class="form-group col-xs-12 col-lg-12 col-lg-12">  
                                    ...
                                    <?=$result_state_byid->id?>
                                    <?php $uri_add = isset($result_state_byid->id)? $result_state_byid->id : -1?>
                                    <?php echo form_open("score/add_thesis/$stu_id/$uri_add", array('id' => 'score_thesis', 'class' => 'form-horizontal')); ?>
                                        <div class="form-group" style="margin-bottom: 10px;">
                                            
                                            <div class="col-xs-12 col-md-12 col-lg-12">
                                                <h2 class="page-header">    
                                                    <i class="fa fa-info-circle"></i> <?php echo lang('thesis')?>
                                                </h2>
                                            </div>
                            ...
                            <div class="box-primary box view-item col-xs-12 col-lg-12 no-padding" style="margin-top:1   %">
                                    ...
                                    <div class="box-body table-responsive no-padding">
                                            <table class="table table-striped table-bordered">   
                                                    <tr>
                                                        <th><label><?php echo lang('written')?> Score</label></th>
                                                        <th><label>Total</label></th>
                                                        <th><label><?php echo lang('defence')?></label></th>
                                                        <th><label><?php echo lang('grade')?></label></th>
                                                        <th><label><?php echo lang('rang')?></label></th>
                                                        <th></th>
                                                    </tr>
                                                    <?php echo $manage_result_sco_thesis?>
                                            </table>  
                                   </div>
                                   <!--./end box-body-->
                            </div>
...
<script type='text/javascript'>
    ...
    $(document).ready(function()
    {  
        setTimeout(function(){$(":input:visible:first", "#score_thesis").focus(); }, 100);
        $('#score_thesis').validate({
    ...
    function scoreSubmit(form)
    {
        ...
        $(form).ajaxSubmit({
            success:function(response)
            {
                ...
                if (response.success)
                {
                    window.location.href = '<?php echo site_url("$controller_name/thesis/$stu_acad_id"); ?>'
                }
            },
