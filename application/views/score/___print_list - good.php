        ...
        <!-- center -->
            ...
            <div style="margin-top:22px">
                <div class="head_center">
                    ...
                    <div class="head_s3">មហាវិទ្យាល័យ<?php echo ($get_stu->row()->university_name)? $get_stu->row()->university_name : ''?> ជំនាន់ទី null</div>
                            ...
                            <tr>                       
                                ...
                                <?php if($subject->num_rows() > 0): ?>       
                                    <?php foreach($subject->result() as $r_subject):?> 
                                        ...
                                        <?php if($result_score->num_rows() > 0): ?>
                                            
                                            <?php foreach($result_score->result() as $r_socre): ?>
                                                <?php
                                                    $x++;
                                ...
                                <!-- <th style="color:blue;font-weight: bold;"><?php echo $sum_all?></th>                     
                                <th style="color:red;font-weight: bold;"><?php echo $sum_all;?></th>                     
                                <th style="color:blue;font-weight: bold;">0</th>   -->                   
                            </tr>
                        <?php endforeach ?>
                    <?php endif ?>
