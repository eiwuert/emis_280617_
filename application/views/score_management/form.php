                    ...
                    <!-- </div>      -->
                        ...
                        Fields in red are required    <div class="widget-box">
                                ...
                                <form action="" method="post" accept-charset="utf-8" id="" class="form-horizontal" novalidate="novalidate">
                                                ...
                                                <div class="form-group" style="margin-bottom: 10px;">
                                                    <label for="total_semester_i" class="required col-sm-3 col-md-3 col-lg-2 " aria-required="true">Total Semester I:</label>    
                                                    <div class="col-sm-9 col-md-9 col-lg-5">
                                                        <input class="filter form-control" name="total_semester_i" type="text" value="" />
                                                    </div>
                                                </div>


                                                <div class="form-group" style="margin-bottom: 10px;">
                                                    <label for="total_semester_ii" class="required col-sm-3 col-md-3 col-lg-2 " aria-required="true">Total Semester II:</label>    
                                                    <div class="col-sm-9 col-md-9 col-lg-5">
                                                        <input class="filter form-control" name="total_semester_ii" type="text" value="" />
                                                    </div>
                                                </div>


                                                <div class="form-group" style="margin-bottom: 10px;">
                                                    <label for="total_score" class="required col-sm-3 col-md-3 col-lg-2 " aria-required="true">Total Score:</label>    
                                                    <div class="col-sm-9 col-md-9 col-lg-5">
                                                        <input class="filter form-control" name="total_score" type="text" value="" />
                                                    </div>
                                                </div>


                                                <div class="form-group" style="margin-bottom: 10px;">
                                                    <label for="average" class="required col-sm-3 col-md-3 col-lg-2 " aria-required="true">Average:</label>    
                                                    <div class="col-sm-9 col-md-9 col-lg-5">
                                                        <input class="filter form-control" name="average" type="text" value="" />
                                                    </div>
                                                </div>


                                                <div class="form-group" style="margin-bottom: 10px;">
                                                    <label for="ranking" class="required col-sm-3 col-md-3 col-lg-2 " aria-required="true">Ranking:</label>    
                                                    <div class="col-sm-9 col-md-9 col-lg-5">
                                                        <input class="filter form-control" name="ranking" type="text" value="" />
                                                    </div>
                                                </div>
