                    ...
                    <!-- </div>      -->
                        ...
                        Fields in red are required    <div class="widget-box">
                                ...
                                <form action="" method="post" accept-charset="utf-8" id="" class="form-horizontal" novalidate="novalidate">
                                                ...
                                                <div class="form-group" style="margin-bottom: 10px;">
                                                    <label for="class" class="required col-sm-3 col-md-3 col-lg-2 " aria-required="true">Class:</label>    
                                                    <div class="col-sm-9 col-md-9 col-lg-5">
                                                        <input name="class" id="class" class="filter form-control" value=""></input> 
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group" style="margin-bottom: 10px;">
                                                    ...
                                                    <div class="col-sm-9 col-md-9 col-lg-5">
                                                        <input name="table" id="table" class="filter form-control" value=""></input> 
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-actions">
                                                    <div>
                                                        <a class="btn btn-active pull-right" style="margin-left:1%" href="<?=site_url("$controller_name/final_exam")?>">Cancel</a>
                                                    </div>
                                                    <div>
