...
<div class="main-content-inner">
    ...
    <div class="page-header" id='page-header'>
        <h1> <i class="icon fa fa-list"></i><?php echo lang('module_professors'); ?> Report</h1>
    </div>    
                    ...
                    <div class="row col-xs-12">
                        ...
                        <div class="col-xs-12 col-sm-3 col-lg-3" id="faculty">
                            <div class="form-group">
                                ...
                                <?php echo form_dropdown('faculty',$select_faculty,($faculty)? $faculty:'','class="form-control"')?>
                            </div>   
                        </div>
                        <div class="col-xs-12 col-sm-3 col-lg-3" id="major">
                            <div class="form-group">
                                <label class="control-label"><?php echo lang('major'); ?></label>
                                <?php echo form_dropdown('major',$select_major, ($major)? $major:'','class="form-control"')?>
                            </div>   
                        </div> 
                        <div class="col-xs-12 col-sm-3 col-lg-3" id="major">
                            <div class="form-group">
                                <label class="control-label"><?php echo lang('common_table_view'); ?></label>
                                <?php echo form_dropdown('table_type',$selection_table_type,($table_type)? $table_type : '','class="form-control"')?>
                            </div>   
                        </div>            
                        <div class="form-group col-xs-12 col-lg-12 col-lg-12">  
                            <div class="row col-xs-12">
                                <a href="<?php echo site_url("report_employee/clear_state")?>" style="margin-left:15px" class="btn btn-active pull-left">Clear</a> 
