...
header("Content-Disposition: attachment; filename=Student Report Summery -".date("Y-m-d H:i:s").".xls");


$headPrint="<table>
                <tr>
                    <td colspan='2' rowspan='10' height='45'>
                        <center><img width='4%' src='".base_url('assets/img/logo.png')."'></center>
                    </td>
