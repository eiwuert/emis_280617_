...
header("Content-Disposition: attachment; filename=Student Report Score -".date("Y-m-d H:i:s").".xls");

$headPrint="<table>
                <tr>
                    <td colspan='1' rowspan='14' height='45'>
                ...
                <tr>
                    <td colspan='4' class='head_eng1' style='text-transform: capitalize'><center><b>Batch: ".$main_title_batch."</b></center></td> 
                </tr>
                <tr>
                    <td colspan='4' class='head_eng1' style='text-transform: capitalize'><center><b>Degree: ".$main_title_degree."</b></center></td> 
                </tr>     
                <tr>
                    <td colspan='4' class='head_eng1' style='text-transform: capitalize'><center><b>Semester: ".$main_title_semester."</b></center></td> 
                </tr>
                <tr>
                    <td colspan='4' class='head_eng1' style='text-transform: capitalize'><center><b>Grade: ".$main_title_grade."</b></center></td> 
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan='4' class='head_eng1' style='text-transform: capitalize'><center><b>Subject: ".$main_title_subject."</b></center></td> 
                </tr>
            </table>";
echo $headPrint;
echo $manage_table;