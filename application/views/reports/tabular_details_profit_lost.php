...
<script type="text/javascript" language="javascript">
    ...
    $("#generate_report").click(function()
    {
        ...
        if (project_titles != "") {
            project_titles = project_titles.replace(',', '-')
        } else {
            project_titles = 'all'
        }
        if (project_managers != "") {
            project_managers = project_managers.replace(',', '-')
        } else {
        ...
        {
            window.location = window.location+'/'+$("#report_date_range_simple option:selected").val() +'/'+export_excel+'/'+project_titles+'/'+project_managers+'/'+clients;
        }
        else
        {
            ...
            window.location = window.location+'/'+start_date + '/'+ end_date +'/'+ export_excel+'/'+project_titles+'/'+project_managers+'/'+clients;
        }
    });
