...
<script type="text/javascript" language="javascript">
    ...
    $("#generate_report").click(function()
    {
        ...
        {
            window.location = window.location+'/'+$("#report_date_range_simple option:selected").val() +'/'+export_excel+'/'+project_titles+'/'+project_managers;
        }
        else
        {
            ...
            window.location = window.location+'/'+start_date + '/'+ end_date +'/'+ export_excel+'/'+project_titles+'/'+project_managers;
        }
    });
