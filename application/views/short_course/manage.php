...
<script type="text/javascript">
    $(document).ready(function (){
        var table_columns = ['', 'courses_title', 'courses_venue', 'courses_date_from','courses_date_to','courses_orgainized','courses_male_participants','courses_female_participants',''];
