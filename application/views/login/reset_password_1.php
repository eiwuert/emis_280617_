...
<html lang="en">
    ...
    <body>
        <div id="login_header">
            ...
            <h2 id="reset_password"> <?php echo lang('login_reset_password')?></h2>
        </div>
        <div id="container">
            <div id="logo">
                <?php
...
<?php if (is_on_demo_host()) { ?>
                ...
                <?php } ?>
            <div id="loginbox_reset">            
<?php echo form_open('login/do_reset_password_notify', array('class' => 'form login-form')); ?>
                <h3 id="reset_password"><?php echo lang('login_reset_passwords'); ?></h3>
                <span id="reset"><?php echo lang('login_reset_password_byemail'); ?></span>
                <center>
                    <table id="tb">
                    <tr>
