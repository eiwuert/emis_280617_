...
<script type="text/javascript">
    ...
    {
        var table_columns = ["","po_id","company_name","po_date"];
        ...
        enable_search('<?php echo site_url("$controller_name/suggest_po"); ?>',<?php echo json_encode(lang("common_confirm_search")); ?>);
            ...
            <div class="col-xs-30">
                <div class="widget-box" id="widgets">
                    <div class="widget-title">
                        <h5>
                            <i class="fa fa-th"></i> <?php echo lang('common_list_of') . ' ' . lang('module_' . $controller_name); ?>
                        </h5>
                            ...
                            <a href="<?php echo site_url($controller_name.'/clear_state'); ?>" class="clear-state pull-right">
                                <span title="clear" class="label label-info tip-left">
                                    <?php echo lang('common_clear_search'); ?>
                                </span>
                            </a>
                    </div>
