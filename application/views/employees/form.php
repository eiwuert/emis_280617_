...
<?php echo lang('common_fields_required_message'); ?>
    <div class="widget-box">
        ...
        <div class="widget-body" style="margin-left: 13px;">
            ...
            <?php
                //echo form_open_multipart('employees/save/' . $person_info->person_id, array('id' => 'employee_form', 'class' => 'form-horizontal'));
            ?>
            <div class="form-group required" style="margin-bottom: 10px;">
                <?php echo form_label(lang('employees_id') . ':', 'emp_unique_id', array('class' => $required . ' col-sm-3 col-md-3 col-lg-2 control-label')); ?>
            ...
            <div class="form-group" style="margin-bottom: 10px;">
                <?php
                echo form_label(lang('common_faculty') . ':', 'emp_master_department_id', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label'));
                ?>
                <div class="col-sm-9 col-md-9 col-lg-5">
                    <?php
