...
<div id="mydiv">
	<style type="text/css">
			...
			page {
			  background: white;		  
			  background-image: url('assets/img/associate.png');
				...
				<!-- start -->
					<div>
						...
						<div class="body_txt_center">						
							<div class="txt_center_welcom">បរិញ្ញាបត្ររង</div>
							<div class="txt_center_welcom_bottom">ASSOCIATE’S DEGREE</div>
						</div>
	...
	Academic Board of the University of Management and Economics</div>
							...
							<div class="cen_right_major"><div style="float:left">in:</div><div class="cen_right_major_span">Banking and Finance</div><br>This Bachelor’s degree is presented to the bearer with all rights and privileges thereto pertaining.</div>
						</div>
						<!--  -->
						<div class="foot_left">
