...
<script type="text/javascript">
    $(document).ready(function (){
        var table_columns = ['', 'workshop_title', 'workshop_venue', 'workshop_date_from','workshop_date_to','workshop_orgainized','workshop_male_participants','workshop_female_participants',''];
